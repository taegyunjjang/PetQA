...
"score1_description": "모델의 응답이 사용자의 요구나 질문과 전혀 관련이 없거나 도움이 되지 않습니다.",
"score2_description": "가끔 유용한 정보를 제공하지만, 자주 사용자의 실제 요구를 충족하지 못합니다.",
"score3_description": "대체로 사용자의 요구를 반영한 유용한 응답을 제공하나, 가끔 핵심을 놓치기도 합니다.",
"score4_description": "대부분의 경우 질문에 잘 부합하는 유용한 응답을 제공하며, 부정확한 부분은 드뭅니다.",
"score5_description": "항상 높은 관련성과 유용성을 갖춘 응답을 제공하여 사용자의 요구를 완벽히 충족합니다."
"""