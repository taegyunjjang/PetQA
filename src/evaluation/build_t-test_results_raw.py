...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_format", choices=["preprocessed", "raw"], default="raw")
    ...
    output_path = "./t-test_results_raw.json"
    ...
    for answer_type in answer_types:
        ...
        result[answer_type] = {
            "rougeL_f1": rougeL_f1_scores,
            "bertscore_f1": bertscore_f1_scores,
            "factuality_f1": factuality_f1_scores
        }
