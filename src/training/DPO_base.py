...
def load_model_tokenizer(model_path, model_name, logger):
...
if __name__ == "__main__":
    ...
    model_path = os.path.join(env["checkpoint_dir"], 
                              ...
                              "best_model")
    model, ref_model, tokenizer = load_model_tokenizer(model_path, args.model_name, logger)
    ...
    dpo_config = DPOConfig(
        ...
        max_length=1280,  # prompt + completion
