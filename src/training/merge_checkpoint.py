...
def find_checkpoint(args, checkpoint_dir, logger):
    logger.info(f"Finding checkpoint in {checkpoint_dir}")
    ...
    if args.checkpoint_path:
        ...
        checkpoint_path = os.path.join(checkpoint_dir, args.checkpoint_path)
...
def convert_checkpoint(checkpoint_path, output_dir, model_name, logger):
