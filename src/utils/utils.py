...
def load_environment():
    ...
    SYSTEM_DPO_CLEANING_PROMPT_PATH = os.path.join(PROMPT_DIR, 'system_dpo_cleaning.txt')
    ...
    SYSTEM_PROMETHEUS_PATH = os.path.join(PROMPT_DIR, 'system_prometheus.txt')
    ...
    BATCH_OUTPUT_PATH = os.path.join(BATCH_DIR, 'batch_output.jsonl')
    BATCH_ERROR_PATH = os.path.join(BATCH_DIR, 'batch_error.jsonl')
    ...
    return {
        ...
        "system_dpo_cleaning_prompt_path": SYSTEM_DPO_CLEANING_PROMPT_PATH,
        ...
        "system_prometheus_path": SYSTEM_PROMETHEUS_PATH,
        ...
        "dpo_filtered_data_path": DPO_FILTERED_DATA_PATH,
        "dpo_cleaned_data_path": DPO_CLEANED_DATA_PATH,
